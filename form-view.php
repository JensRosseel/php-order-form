        ...
        <fieldset>
            ...
            <?php foreach ($products as $i => $product): ?>
                <label>
                    ...
                    <input type="checkbox" value="1" name="products[<?php echo $i ?>]" id="products[<?php echo $i ?>]"/> <?php echo $product->getName(); ?> -
                    &euro; <?= $product->getFromattedPrice(); ?></label><br />
            <?php endforeach; ?>
        </fieldset>
